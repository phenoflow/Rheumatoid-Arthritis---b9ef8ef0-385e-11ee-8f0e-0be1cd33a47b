...
steps:
  ...
  seronegative-rheumatoid-arthritis---primary:
    run: seronegative-rheumatoid-arthritis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  rheumatoid-arthritis-nodule---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: seronegative-rheumatoid-arthritis---primary/output
  ...
  rheumatoid-arthritis-unspecified---primary:
    run: rheumatoid-arthritis-unspecified---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  juvenile-rheumatoid-arthritis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: rheumatoid-arthritis-unspecified---primary/output
  pauciarticular-rheumatoid-arthritis---primary:
    run: pauciarticular-rheumatoid-arthritis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  seropositive-rheumatoid-arthritis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: pauciarticular-rheumatoid-arthritis---primary/output
